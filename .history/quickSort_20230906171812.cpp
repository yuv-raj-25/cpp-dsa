...
struct AppInfo {
    ...
    AppInfo(const int& name) : appName(name), usageCount(0) {}
};
...
struct Result altTab(int input1, int input2, vector<int> input3) {
    vector<AppInfo> apps;

    for (const int& appName : input3) {
